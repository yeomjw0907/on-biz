...
import { ArrowLeft, Calendar, User, Eye, Share2, Printer, ChevronRight, Edit } from 'lucide-react';
      ...
      <div className="relative bg-slate-900 text-white py-32 md:py-40 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
             <div className="flex items-center justify-between mb-8">
                 <Link to="/board" className="inline-flex items-center gap-2 text-white/50 hover:text-white transition-colors group text-sm font-medium">
                ...
                <Link 
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-lg text-sm font-bold transition-colors"
                >
                    <Edit size={16} /> 수정하기
                </Link>
             </div>
